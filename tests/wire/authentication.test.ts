...
describe("Authentication", () => {
    ...
    test("authenticateuser (2)", async () => {
        const server = mockServerPool.createServer();
        const client = new TerraClient({ apiKey: "test", devId: "test", environment: server.baseUrl });
        const rawRequestBody = {
            language: undefined,
            reference_id: undefined,
            auth_success_redirect_url: undefined,
            auth_failure_redirect_url: undefined,
        };
        ...
        await expect(async () => {
            return await client.authentication.authenticateuser({
                resource: "resource",
                language: undefined,
                reference_id: undefined,
                auth_success_redirect_url: undefined,
    ...
    test("generatewidgetsession (1)", async () => {
        const server = mockServerPool.createServer();
        const client = new TerraClient({ apiKey: "test", devId: "test", environment: server.baseUrl });
        const rawRequestBody = {};
        const rawResponseBody = {
    ...
    test("generatewidgetsession (2)", async () => {
        const server = mockServerPool.createServer();
        const client = new TerraClient({ apiKey: "test", devId: "test", environment: server.baseUrl });
        const rawRequestBody = {
            providers: undefined,
        ...
        await expect(async () => {
            return await client.authentication.generatewidgetsession({
                providers: undefined,
                language: undefined,
                reference_id: undefined,
                auth_success_redirect_url: undefined,
    ...
    test("deauthenticateuser (1)", async () => {
        const server = mockServerPool.createServer();
        const client = new TerraClient({ apiKey: "test", devId: "test", environment: server.baseUrl });
    ...
    test("deauthenticateuser (2)", async () => {
        const server = mockServerPool.createServer();
        const client = new TerraClient({ apiKey: "test", devId: "test", environment: server.baseUrl });
        ...
        await expect(async () => {
            return await client.authentication.deauthenticateuser({
                user_id: "user_id",
            });
        }).rejects.toThrow(
            new Terra.NotFoundError({
    ...
    test("generateauthtoken (1)", async () => {
        const server = mockServerPool.createServer();
        const client = new TerraClient({ apiKey: "test", devId: "test", environment: server.baseUrl });
    ...
    test("generateauthtoken (2)", async () => {
        const server = mockServerPool.createServer();
        const client = new TerraClient({ apiKey: "test", devId: "test", environment: server.baseUrl });
        ...
        await expect(async () => {
            return await client.authentication.generateauthtoken();
        }).rejects.toThrow(
            new Terra.NotFoundError({
                key: "value",
            }),
