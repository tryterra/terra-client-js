...
describe("Daily", () => {
    ...
    test("fetch (2)", async () => {
        ...
        server.mockEndpoint().get("/daily").respondWith().statusCode(400).jsonBody(rawResponseBody).build();

        await expect(async () => {
            return await client.daily.fetch({
                user_id: "user_id",
                start_date: 1,
            });
        }).rejects.toThrow(
    ...
    test("fetch (3)", async () => {
        ...
        const rawResponseBody = { key: "value" };
        server.mockEndpoint().get("/daily").respondWith().statusCode(401).jsonBody(rawResponseBody).build();
    ...
    test("fetch (4)", async () => {
        ...
        const rawResponseBody = { key: "value" };
        server.mockEndpoint().get("/daily").respondWith().statusCode(404).jsonBody(rawResponseBody).build();
