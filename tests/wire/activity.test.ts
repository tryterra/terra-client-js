...
describe("Activity", () => {
    ...
    test("fetch (2)", async () => {
        ...
        server.mockEndpoint().get("/activity").respondWith().statusCode(400).jsonBody(rawResponseBody).build();

        await expect(async () => {
            return await client.activity.fetch({
                user_id: "user_id",
                start_date: 1,
            });
        }).rejects.toThrow(
    ...
    test("fetch (3)", async () => {
        ...
        const rawResponseBody = { key: "value" };
        server.mockEndpoint().get("/activity").respondWith().statusCode(401).jsonBody(rawResponseBody).build();
    ...
    test("fetch (4)", async () => {
        ...
        const rawResponseBody = { key: "value" };
        server.mockEndpoint().get("/activity").respondWith().statusCode(404).jsonBody(rawResponseBody).build();
    ...
    test("write (2)", async () => {
        ...
        const rawRequestBody = {
            data: [
                {
                    active_durations_data: undefined,
                    calories_data: undefined,
                    cheat_detection: undefined,
                    data_enrichment: undefined,
                    device_data: undefined,
                    distance_data: undefined,
                    ...
                    movement_data: undefined,
                    oxygen_data: undefined,
                    polyline_map_data: undefined,
                    position_data: undefined,
                    power_data: undefined,
                    strain_data: undefined,
                    TSS_data: undefined,
                    work_data: undefined,
                },
                {
        ...
        await expect(async () => {
            return await client.activity.write({
                data: [
                    {
                        active_durations_data: undefined,
                        calories_data: undefined,
