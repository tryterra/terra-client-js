...
describe("Menstruation", () => {
    ...
    test("fetch (2)", async () => {
        ...
        server.mockEndpoint().get("/menstruation").respondWith().statusCode(400).jsonBody(rawResponseBody).build();

        await expect(async () => {
            return await client.menstruation.fetch({
                user_id: "user_id",
                start_date: 1,
            });
        }).rejects.toThrow(
    ...
    test("fetch (3)", async () => {
        ...
        const rawResponseBody = { key: "value" };
        server.mockEndpoint().get("/menstruation").respondWith().statusCode(401).jsonBody(rawResponseBody).build();
    ...
    test("fetch (4)", async () => {
        ...
        const rawResponseBody = { key: "value" };
        server.mockEndpoint().get("/menstruation").respondWith().statusCode(404).jsonBody(rawResponseBody).build();
